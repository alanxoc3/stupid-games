...
int main(int argc, char ** argv) {
	...
	while(!loopFlag) {
		...
		// Draw the Player and the pushable rectangle.
		...
		// Here is timer stuff. SDL_Delay pauses time. We want to pause
		// time in order for us to have exactly the frame rate if this
	...
	// The Destructors clear the memor for the program.
	return 0;
}
